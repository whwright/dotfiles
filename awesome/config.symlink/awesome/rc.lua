...
-- vicious widgets
-- cpu graph
cpu_graph_widget = wibox.widget.graph()
cpu_graph_widget:set_width(50)
cpu_graph_widget.background_color = beautiful.bg_normal
cpu_graph_widget:set_color({
        type = "linear",
        from = { 0, 0 }, to = { 50, 0 },
        stops = {
            { 0, "#FF5656" },
...
-- restart awesome when moving displays
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            battery.widget and separator or nil,
